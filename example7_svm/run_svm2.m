...
%use BFGS hessian update for the optimization
myoptions = fdipa_options('MaxIterations',10000);
C1=100; C2=100;
...
clear 'Accu' 'AUC' 'const' 'C1' 'C2' 'eta_opt' 'fun' 'fval' 'iter' 'kappa' 'kappa_opt' ...
